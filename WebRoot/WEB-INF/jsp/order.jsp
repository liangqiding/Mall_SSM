...
<div class="navbara">
  ...
  <a href="${pageContext.request.contextPath }/customer/S.action" id="">返回</a>
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr class="tr">
									...
									<td>${row.o_state}</td>
									<td>
										<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick= "editCustomer(${row.o_id})">修改</a>
										
										<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${row.o_id})">取消订单</a>
										<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${row.o_id})">确认收货</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
